...
> **Info:** For a full breakdown of how the Conditional Token Framework works, see [CTF Overview](/trading/ctf/overview). This page focuses on the MM workflow using the Relayer Client.
...
- **[CTF Overview](/trading/ctf/overview)** — How the Conditional Token Framework works under the hood

- **[Split Tokens](/trading/ctf/split)** — Detailed split function parameters and prerequisites

- **[Merge Tokens](/trading/ctf/merge)** — Detailed merge function parameters

- **[Gasless Transactions](/trading/gasless)** — Relayer Client setup and configuration
